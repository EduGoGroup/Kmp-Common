...
public object JvmShared {
     ...
     */
    public fun getOsName(): String = System.getProperty("os.name") ?: "Unknown"
     ...
     */
    public fun accessCommonFromJvmShared(): String = SharedClass.commonFunction()
}
